...
struct reg_state {
	...
	volatile CPU_INT08U u8LedMap;						/*! bit de chaque led */
	volatile CPU_INT08U char_recu;						/*! char recu par uart	*/
...
*/
struct reg_acd_ok {
	volatile CPU_INT16U acq_prise;						/*! Nombre d'acd_prise dans intr_temps (utiliser pour auto calc adc_fhz) */
	volatile CPU_INT16U acq_tranmise;					/*! Nombre d'acd_transmise dans intr_temps (utiliser pour auto calc adc_fhz)  */
};
...
*/
struct reg_acd_freq {
	volatile CPU_INT16U adc_fhz;						/*! Frequence du adc_start */
	CPU_INT16U adc_prev;								/*! Frequence du adc_start precedente (pour eviter trop de changement) */
};
